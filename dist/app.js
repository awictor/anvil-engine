...
import { corsMiddleware, rateLimitMiddleware, authMiddleware, errorToResponse } from "./middleware.js";
...
export function buildApp(config) {
    ...
    const deps = { sessionManager, actions, pool, config };
    ...
    const server = createServer(async (req, res) => {
        ...
        if (touched)
            sessionManager.touch(touched.id);
        try {
